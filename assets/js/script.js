...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    await loadSection('app-content', './sections/alur.html');
    ...
    if (typeof window.initKaryaLogic === 'function') { window.initKaryaLogic(); } 
    if (typeof window.initAlurLogic === 'function') { window.initAlurLogic(); }// <--- EKSEKUSI JS KARYA
